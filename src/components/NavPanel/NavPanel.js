              ...
              <div className="cfc-toolbar-tools">
                <div className="cfc-icon cfc-icon-COMPUTE_SECTION cfc-icon-size-large">
                  <span className="mat-icon ng-star-inserted">
                    <svg id="" fill="none" fillRule="evenodd" height="100%" viewBox="0 0 32 32" width="100%" fit="" preserveAspectRatio="xMidYMid meet" focusable="false">
                      ...
                      <div className="cfc-icon cfc-icon-instance cfc-icon-size-small">
                        <span className="mat-icon ng-star-inserted">
                          <svg id="" width="100%" height="100%" viewBox="0 0 18 18" fit="" preserveAspectRatio="xMidYMid meet" focusable="false">
                            <path d="M13.998 16A1.01 1.01 0 0 0 15 14.993V4.007C15 3 13.998 2 12.998 2H5.002C4.002 2 3 3 3 4.007v10.986C3 15.55 3.45 16 4.002 16H5.5l.5-1h6l.5 1h1.498zM6 9.5a.5.5 0 0 1 .49-.5h5.02a.5.5 0 0 1 0 1H6.49A.5.5 0 0 1 6 9.5zm0 2a.5.5 0 0 1 .49-.5h5.02a.5.5 0 0 1 0 1H6.49a.5.5 0 0 1-.49-.5zM8 6c0-.552.444-1 1-1 .552 0 1 .444 1 1 0 .552-.444 1-1 1-.552 0-1-.444-1-1z" fillRule="evenodd"></path>
                          </svg>
                        </span>
                      </div>
                  ...
                  <a className="mat-button">
                    <span className="mat-button-wrapper">
                      ...
                      <div className="cfc-icon cfc-icon-instance-group cfc-icon-size-small">
                        <span className="mat-icon ng-star-inserted">
                          <svg id="" width="100%" height="100%" viewBox="0 0 18 18" fit="" preserveAspectRatio="xMidYMid meet" focusable="false">
                            <path d="M12 11h-2v3.993c0 .557.003 1.007.003 1.007h1l1-1h1.995l1 1h1L16 9.003c0-.55-.45-.996-.99-.996H13V10a1 1 0 1 1-1 1zm-7-1V8.007H2.99a.996.996 0 0 0-.99 1v5.986C2 15.55 2.002 16 2.002 16h1l1-1h1.996l1 1h1v-5H6a1 1 0 1 1-1-1zm6.998 0L12 3.003c0-.55-.45-.996-.99-.996H6.99a.996.996 0 0 0-.99 1v5.986C6 9.55 6.002 10 6.002 10h1l1-1h1.996l1 1h1zM9 6a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" fillRule="evenodd"></path>
                          </svg>
                        </span>
                      </div>
                  ...
                  <a className="mat-button">
                    <span className="mat-button-wrapper">
                      ...
                      <div className="cfc-icon cfc-icon-instance-template cfc-icon-size-small">
                        <span className="mat-icon ng-star-inserted">
                          <svg id="" width="100%" height="100%" viewBox="0 0 18 18" fit="" preserveAspectRatio="xMidYMid meet" focusable="false">
                            <path d="M13.998 16A1.01 1.01 0 0 0 15 14.993V4.007C15 3 13.998 2 12.998 2H5.002C4.002 2 3 3 3 4.007v10.986C3 15.55 3.45 16 4.002 16H5.5l.5-1h6l.5 1h1.498zM5 4h8v9H5V4zm1 5.5a.5.5 0 0 1 .49-.5h5.02a.5.5 0 0 1 0 1H6.49A.5.5 0 0 1 6 9.5zM8 5h2v2H8V5zm-2 6.5a.5.5 0 0 1 .49-.5h5.02a.5.5 0 0 1 0 1H6.49a.5.5 0 0 1-.49-.5z" fillRule="evenodd"></path>
                          </svg>
                        </span>
                      </div>
                  ...
                  <a className="mat-button">
                    <span className="mat-button-wrapper">
                      ...
                      <div className="cfc-icon cfc-icon-instance-disk  cfc-icon-size-small">
                        <span className="mat-icon ng-star-inserted">
                          <svg id="" width="100%" height="100%" viewBox="0 0 18 18" fit="" preserveAspectRatio="xMidYMid meet" focusable="false">
                            <path d="M3 3.007A1.01 1.01 0 0 1 4.002 2h9.996C14.55 2 15 2.45 15 3.007v11.986A1.01 1.01 0 0 1 13.998 16H4.002C3.45 16 3 15.55 3 14.993V3.007zM9 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8zm-3 1.5a.5.5 0 0 1 .49-.5h5.02a.5.5 0 0 1 0 1H6.49a.5.5 0 0 1-.49-.5zM9 9a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" fillRule="evenodd"></path>
                          </svg>
                        </span>
                      </div>
                  ...
                  <a className="mat-button">
                    <span className="mat-button-wrapper">
                      ...
                      <div className="cfc-icon cfc-icon-instance-image cfc-icon-size-small">
                        <span className="mat-icon ng-star-inserted">
                          <svg id="" width="100%" height="100%" viewBox="0 0 18 18" fit="" preserveAspectRatio="xMidYMid meet" focusable="false">
                            <path d="M6 4H4v10h2v2h6v-2h2V4h-2V2H6v2zM2 2h14v14H2V2zm3 3h2v3H5V5zm6 5h2v3h-2v-3zM8 5h5v3H8V5zm2 1h1v1h-1V6zm-5 4h5v3H5v-3zm2 1h1v1H7v-1z" fillRule="evenodd"></path>
                          </svg>
                        </span>
                      </div>
                  ...
                  <a className="mat-button">
                    <span className="mat-button-wrapper">
                      ...
                      <div className="cfc-icon cfc-icon-instance-use-discounts cfc-icon-size-small">
                        <span className="mat-icon ng-star-inserted">
                          <svg id="" width="100%" height="100%" viewBox="0 0 18 18" fit="" preserveAspectRatio="xMidYMid meet" focusable="false">
                            <path d="M16.997 7.27L17 4a1 1 0 0 0-1-1H2c-.552 0-1 .456-1 1.002v3.266a2 2 0 0 1 0 3.464v3.266A1 1 0 0 0 2 15h13.992c.553 0 1-.456 1-1.002l.003-3.268a2 2 0 0 1 .002-3.46zM6 9a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm0-1a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm6 5a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm0-1a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-1.225-7l.866.5-4.37 7.578-.863-.5L10.777 5z" fillRule="evenodd"></path>
                          </svg>
                        </span>
                      </div>
                  ...
                  <a className="mat-button">
                    <span className="mat-button-wrapper">
                      ...
                      <div className="cfc-icon cfc-icon-instance-metadata cfc-icon-size-small">
                        <span className="mat-icon ng-star-inserted">
                          <svg id="" width="100%" height="100%" viewBox="0 0 18 18" fit="" preserveAspectRatio="xMidYMid meet" focusable="false">
                            <path d="M2 2h6v2H2V2zm0 4h6v2H2V6zm0 4h6v2H2v-2zm0 4h6v2H2v-2zm8-12h6v2h-6V2zm0 4h6v2h-6V6zm0 4h6v2h-6v-2zm0 4h6v2h-6v-2z" fillRule="evenodd"></path>
                          </svg>
                        </span>
                      </div>
                  ...
                  <a className="mat-button">
                    <span className="mat-button-wrapper">
                      ...
                      <div className="cfc-icon cfc-icon-instance-health-check-new cfc-icon-size-small">
                        <span className="mat-icon ng-star-inserted">
                          <svg id="" width="100%" height="100%" viewBox="0 0 18 18" fit="" preserveAspectRatio="xMidYMid meet" focusable="false">
                            <path d="M8 12H6v-2h2V8h2v2h2v2h-2v2H8v-2zM5 6V5a3 3 0 0 1 3-3h2a3 3 0 0 1 3 3v1h1.993C15.55 6 16 6.456 16 6.995v8.01a1 1 0 0 1-1.007.995H3.007A1.008 1.008 0 0 1 2 15.005v-8.01A1 1 0 0 1 3.007 6H5zm2 0h4V4H7v2z" fillRule="evenodd"></path>
                          </svg>
                        </span>
                      </div>
                  ...
                  <a className="mat-button">
                    <span className="mat-button-wrapper">
                      ...
                      <div className="cfc-icon cfc-icon-instance-zones cfc-icon-size-small">
                        <span className="mat-icon ng-star-inserted">
                          <svg id="" width="100%" height="100%" viewBox="0 0 18 18" fit="" preserveAspectRatio="xMidYMid meet" focusable="false">
                            <path d="M10 8V2H2v8h6v6h8V8h-6zM4 4h4v4H4V4zm6 6h4v4h-4v-4zm-8 1h2v2H2v-2zm0 3h2v2H2v-2zM14 2h2v2h-2V2zm-3 0h2v2h-2V2zm3 3h2v2h-2V5zm-9 9h2v2H5v-2z" fillRule="evenodd"></path>
                          </svg>
                        </span>
                      </div>
                  ...
                  <a className="mat-button">
                    <span className="mat-button-wrapper">
                      ...
                      <div className="cfc-icon cfc-icon-instance-history cfc-icon-size-small">
                        <span className="mat-icon ng-star-inserted">
                          <svg id="" width="100%" height="100%" viewBox="0 0 18 18" fit="" preserveAspectRatio="xMidYMid meet" focusable="false">
                            <path d="M16 9A7 7 0 1 1 2 9a7 7 0 0 1 14 0zm-6.956 5.512a5.47 5.47 0 1 0 0-10.937 5.47 5.47 0 0 0 0 10.938zM10 8.586V5H8v4.466h.05l2.718 2.716 1.414-1.414L10 8.586z" fillRule="evenodd"></path>
                          </svg>
                        </span>
                      </div>
                  ...
                  <a className="mat-button">
                    <span className="mat-button-wrapper">
                      ...
                      <div className="cfc-icon cfc-icon-instance-quotas cfc-icon-size-small">
                        <span className="mat-icon ng-star-inserted">
                          <svg id="" width="100%" height="100%" viewBox="0 0 18 18" fit="" preserveAspectRatio="xMidYMid meet" focusable="false">
                            <path d="M16 4.503v9.49A2.005 2.005 0 0 1 13.994 16H4.006A2.005 2.005 0 0 1 2 13.994v-9.49V5h2v9h10V5h2v-.497zM5 8h8v5H5V8zm0-6h2v2H5V2zm3 0h2v2H8V2zm3 0h2v2h-2V2zm3 0h2v3h-2V2zM2 2h2v3H2V2z" fillRule="evenodd"></path>
                          </svg>
                        </span>
                      </div>
